...
//{
//    public HttpEntityService(HttpClient httpClient) : base(httpClient)
//    {
//    }
...
//        var data = new PagingResponse<TEntity>
//        {
...
//    ////var pagingResponse = new DataResult<PagingResponse<TEntity>>
//    //protected async Task<DataResult<PagingResponse<TEntity>>> GetFromJsonAsync(PagingEntity entityParameter)
//    //{
//    //    var queryStringParam = new Dictionary<string, string>
//    //    {
//    //        [HttpFeatureData.PageNumber] = entityParameter.PageNumber.ToString(),
...
//    //    //var response = await this.HttpClient.GetFromJsonAsync<DataResult<PagingResponse<TEntity>>>(QueryHelpers.AddQueryString(this.Url, queryStringParam));
...
//    //// Orig
//    //protected async Task<DataResult<List<TEntity>>> GetAsync()
//    //{
...
//    protected async Task<DataResult<List<TEntity>>> GetAsync()
//    {
//        var data = await this.HttpClient.GetFromJsonAsync<DataResult<List<TEntity>>>(this.Url);
...
//    protected async Task<DataResult<TEntity>> GetAsync(int id)
//    {
//        var data = await this.HttpClient.GetFromJsonAsync<DataResult<TEntity>>(this.Url + id);
